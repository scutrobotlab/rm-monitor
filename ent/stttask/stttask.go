...
const (
	// Label holds the string label denoting the stttask type in the database.
	Label = "stt_task"
	...
	// FieldSttPath holds the string denoting the stt_path field in the database.
	FieldSttPath = "stt_path"
	...
	// Table holds the table name of the stttask in the database.
	Table = "stt_tasks"
	// MatchRoundTable is the table that holds the match_round relation/edge.
	MatchRoundTable = "stt_tasks"
	...
	SourceArtifactColumn = "media_artifact_stt_tasks"
)

// Columns holds all SQL columns for stttask fields.
var Columns = []string{
	FieldID,
	FieldRole,
	FieldStatus,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "stt_tasks"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"match_round_stt_tasks",
	"media_artifact_stt_tasks",
}
...
func StatusValidator(s Status) error {
	...
	case StatusPENDING, StatusDISPATCHING, StatusRUNNING, StatusSUCCEEDED, StatusFAILED:
		return nil
	default:
		return fmt.Errorf("stttask: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the STTTask queries.
...
// BySttPath orders the results by the stt_path field.
func BySttPath(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSttPath, opts...).ToFunc()
}

// BySubtitlePath orders the results by the subtitle_path field.
func BySubtitlePath(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSubtitlePath, opts...).ToFunc()
}
