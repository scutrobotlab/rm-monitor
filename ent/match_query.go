...
type MatchQuery struct {
	...
	withRedTeam      *TeamQuery
	withBlueTeam     *TeamQuery
	withRounds       *MatchRoundQuery
	withLarkMessages *LarkMessageQuery
	withFKs          bool
...
// QueryRedTeam chains the current query on the "red_team" edge.
func (_q *MatchQuery) QueryRedTeam() *TeamQuery {
...
// QueryBlueTeam chains the current query on the "blue_team" edge.
func (_q *MatchQuery) QueryBlueTeam() *TeamQuery {
	query := (&TeamClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *MatchQuery) QueryRounds() *MatchRoundQuery {
...
// QueryLarkMessages chains the current query on the "lark_messages" edge.
func (_q *MatchQuery) QueryLarkMessages() *LarkMessageQuery {
...
func (_q *MatchQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *MatchQuery) FirstIDX(ctx context.Context) string {
...
func (_q *MatchQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *MatchQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *MatchQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *MatchQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MatchQuery) Clone() *MatchQuery {
	...
	return &MatchQuery{
		...
		withRedTeam:      _q.withRedTeam.Clone(),
		withBlueTeam:     _q.withBlueTeam.Clone(),
		withRounds:       _q.withRounds.Clone(),
		withLarkMessages: _q.withLarkMessages.Clone(),
...
// WithRedTeam tells the query-builder to eager-load the nodes that are connected to
// the "red_team" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *MatchQuery) WithRedTeam(opts ...func(*TeamQuery)) *MatchQuery {
	query := (&TeamClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withRedTeam = query
	return _q
}

// WithBlueTeam tells the query-builder to eager-load the nodes that are connected to
// the "blue_team" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *MatchQuery) WithBlueTeam(opts ...func(*TeamQuery)) *MatchQuery {
	query := (&TeamClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withBlueTeam = query
	return _q
}
...
func (_q *MatchQuery) WithRounds(opts ...func(*MatchRoundQuery)) *MatchQuery {
	query := (&MatchRoundClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithLarkMessages tells the query-builder to eager-load the nodes that are connected to
// the "lark_messages" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *MatchQuery) WithLarkMessages(opts ...func(*LarkMessageQuery)) *MatchQuery {
	query := (&LarkMessageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withLarkMessages = query
	return _q
}
...
func (_q *MatchQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Match, error) {
	var (
		...
		loadedTypes = [4]bool{
			...
			_q.withBlueTeam != nil,
			_q.withRounds != nil,
			_q.withLarkMessages != nil,
		}
	)
	if _q.withRedTeam != nil || _q.withBlueTeam != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := _q.withRedTeam; query != nil {
		if err := _q.loadRedTeam(ctx, query, nodes, nil,
			func(n *Match, e *Team) { n.Edges.RedTeam = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withBlueTeam; query != nil {
		if err := _q.loadBlueTeam(ctx, query, nodes, nil,
			func(n *Match, e *Team) { n.Edges.BlueTeam = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRounds; query != nil {
		if err := _q.loadRounds(ctx, query, nodes,
			func(n *Match) { n.Edges.Rounds = []*MatchRound{} },
			func(n *Match, e *MatchRound) { n.Edges.Rounds = append(n.Edges.Rounds, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLarkMessages; query != nil {
		if err := _q.loadLarkMessages(ctx, query, nodes,
			func(n *Match) { n.Edges.LarkMessages = []*LarkMessage{} },
			func(n *Match, e *LarkMessage) { n.Edges.LarkMessages = append(n.Edges.LarkMessages, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MatchQuery) loadRedTeam(ctx context.Context, query *TeamQuery, nodes []*Match, init func(*Match), assign func(*Match, *Team)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Match)
	for i := range nodes {
		if nodes[i].team_red_matches == nil {
			continue
		}
		fk := *nodes[i].team_red_matches
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "team_red_matches" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *MatchQuery) loadBlueTeam(ctx context.Context, query *TeamQuery, nodes []*Match, init func(*Match), assign func(*Match, *Team)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Match)
	for i := range nodes {
		if nodes[i].team_blue_matches == nil {
			continue
		}
		fk := *nodes[i].team_blue_matches
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "team_blue_matches" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *MatchQuery) loadRounds(ctx context.Context, query *MatchRoundQuery, nodes []*Match, init func(*Match), assign func(*Match, *MatchRound)) error {
	...
	query.withFKs = true
	query.Where(predicate.MatchRound(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(match.RoundsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.match_rounds
		if fk == nil {
			return fmt.Errorf(`foreign-key "match_rounds" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "match_rounds" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *MatchQuery) loadLarkMessages(ctx context.Context, query *LarkMessageQuery, nodes []*Match, init func(*Match), assign func(*Match, *LarkMessage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Match)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.LarkMessage(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(match.LarkMessagesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.match_lark_messages
		if fk == nil {
			return fmt.Errorf(`foreign-key "match_lark_messages" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "match_lark_messages" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
