...
func main() {
	...
	if err := logic.Run(ctx, client, redisClient, logic.CheckConfig{ArgoConf: c.ArgoConf, K8sJobConf: c.K8sJobConf, OCRServerConf: c.OCRServerConf, WhisperServerURLs: c.WhisperServerUrls}); err != nil {
		logx.Error(err)
		os.Exit(1)
	}
}
